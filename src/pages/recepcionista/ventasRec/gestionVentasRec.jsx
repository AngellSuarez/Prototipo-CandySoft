...
import { User, Search, Calendar, Table, ChevronLeft, ChevronRight, Star, X } from "lucide-react"
...
const GestionVentasRec = () => {
    ...
    if (tipoVenta === "Directa") {
      ...
      try {
        ...
        const resVenta = await fetch(
          "https://angelsuarez.pythonanywhere.com/api/cita-venta/citas-venta/venta-directa/",
          {
            method: "POST",
      ...
      try {
        const resActualizar = await fetch(
          `https://angelsuarez.pythonanywhere.com/api/cita-venta/citas-venta/${codigoCita}/terminar/`,
          {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
          },
  ...
  useEffect(() => {
    const cargarManicuristas = async () => {
      const data = await obtenerTodosManicuristas()
    ...
    if (citaSeleccionada) {
      ...
      try {
        ...
        const response = await axios.get(
          `https://angelsuarez.pythonanywhere.com/api/cita-venta/servicios-cita/?cita_id=${codigoCita}`,
        )
                        ...
                        <div className="fila-formulario">
                          ...
                          <div className="campo">
                            ...
                            <select
                              ...
                              onChange={(e) => setFormVenta({ ...formVenta, manicurista: e.target.value })}
                              required
                            >
