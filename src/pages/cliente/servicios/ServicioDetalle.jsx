    ...
    <>
      <nav className="nav-container">
        ...
        <div className={`nav-menu ${menuMobile ? "active" : ""}`}>
          ...
          >
            <div
              className={`acceso-link ${showMenuServicio || location.pathname.startsWith("/cliente/servicios/") ? "active" : ""}`}
            >
              <Link
      ...
      <div className="servicio-detalle">
        ...
        <div className="servicio-detalle-info">
          ...
          <div className="fila-formulario">
            ...
            <p className="servicio-duracion">
              <strong>Duración:</strong> {servicio.duracion}
            </p>
          </div>
          <Link to={`/cliente/citas/crear?servicio=${servicio.id}`}>
