...
const GestionClientes = () => {
    ...
    const handle_crear_cliente = async (e) => {
        ...
        try {
            ...
            // ⬇️ Aquí actualizas la tabla de clientes si usas un estado como setClientes
        ...
        if (resultado.isConfirmed) {
            try {
                ...
                await MySwal.fire(swalConfig).then(() => {
                    if (
                        respuestaApi?.message === "El usuario y cliente fueron eliminados correctamente" ||
                        respuestaApi?.message === "Cliente y usuario asociado desactivado correctamente"
                    ) {
                        setClientes((prev) => {
                            const actualizados =
                                respuestaApi?.message === "El usuario y cliente fueron eliminados correctamente"
